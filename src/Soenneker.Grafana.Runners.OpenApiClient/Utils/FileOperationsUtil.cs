...
using Soenneker.Grafana.Runners.OpenApiClient.Utils.Abstract;
...
namespace Soenneker.Grafana.Runners.OpenApiClient.Utils;
...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        string openApiDocumentUrl = _configuration["Grafana:ClientGenerationUrl"] ?? "https://raw.githubusercontent.com/grafana/grafana/main/public/openapi3.json";
        ...
        await _kiotaUtil.Generate(fixedFilePath, "GrafanaOpenApiClient", Constants.Library, gitDirectory, cancellationToken).NoSync();
